...
#define _pq_vector8_fp(middle, last, BATCH_OPCODE, DOUBLE_READ_ADDERS, BATCH_MACHINE) \
    PQ_RUN_OPCODE_R3_R2(BATCH_OPCODE, BATCH_MACHINE);                                 \
    if (middle)                                                                       \
    {                                                                                 \
        asm volatile("STRD r4,r5,[r1],#8");                                           \
    }                                                                                 \
    asm volatile("LDMIA  r0!,{r4-r5}");                                               \
    if (DOUBLE_READ_ADDERS)                                                           \
    {                                                                                 \
        asm volatile("MRRC p0,#0,r2,r3,c1");                                          \
    }                                                                                 \
    else                                                                              \
    {                                                                                 \
        asm volatile("MRRC p0,#0,r2,r3,c0");                                          \
    }                                                                                 \
    PQ_RUN_OPCODE_R5_R4(BATCH_OPCODE, BATCH_MACHINE);                                 \
    asm volatile("STRD r2,r3,[r1],#8");                                               \
    asm volatile("LDMIA  r0!,{r6-r7}");                                               \
    if (DOUBLE_READ_ADDERS)                                                           \
    {                                                                                 \
        asm volatile("MRRC p0,#0,r4,r5,c1");                                          \
    }                                                                                 \
    else                                                                              \
    {                                                                                 \
        asm volatile("MRRC p0,#0,r4,r5,c0");                                          \
    }                                                                                 \
    PQ_RUN_OPCODE_R7_R6(BATCH_OPCODE, BATCH_MACHINE);                                 \
    asm volatile("STRD r4,r5,[r1],#8");                                               \
    asm volatile("LDRD r4,r5,[r0],#8");                                               \
    if (DOUBLE_READ_ADDERS)                                                           \
    {                                                                                 \
        asm volatile("MRRC p0,#0,r6,r7,c1");                                          \
    }                                                                                 \
    else                                                                              \
    {                                                                                 \
        asm volatile("MRRC p0,#0,r6,r7,c0");                                          \
    }                                                                                 \
    PQ_RUN_OPCODE_R5_R4(BATCH_OPCODE, BATCH_MACHINE);                                 \
    asm volatile("STRD r6,r7,[r1],#8");                                               \
    if (!last)                                                                        \
    {                                                                                 \
        asm volatile("LDRD r2,r3,[r0],#8");                                           \
    }                                                                                 \
    else                                                                              \
    {                                                                                 \
        asm volatile("NOP");                                                          \
...
#define _pq_vector8_fx(middle, last, BATCH_OPCODE, DOUBLE_READ_ADDERS, BATCH_MACHINE) \
    ...
    if (DOUBLE_READ_ADDERS)                                                           \
    {                                                                                 \
        asm volatile("MRC  p0,#0x1,r2,c1,c0,#0");                                     \
        asm volatile("MRC  p0,#0x1,r3,c3,c0,#0");                                     \
    }                                                                                 \
    else                                                                              \
    {                                                                                 \
        asm volatile("MRC  p0,#0,r2,c1,c0,#0");                                       \
        asm volatile("MRC  p0,#0,r3,c3,c0,#0");                                       \
    }                                                                                 \
    PQ_RUN_OPCODE_R4_R5(BATCH_OPCODE, BATCH_MACHINE);                                 \
    asm volatile("STRD r2,r3,[r1],#8");                                               \
    if (DOUBLE_READ_ADDERS)                                                           \
    {                                                                                 \
        asm volatile("MRC  p0,#0x1,r4,c1,c0,#0");                                     \
        asm volatile("MRC  p0,#0x1,r5,c3,c0,#0");                                     \
    }                                                                                 \
    else                                                                              \
    {                                                                                 \
        asm volatile("MRC  p0,#0,r4,c1,c0,#0");                                       \
        asm volatile("MRC  p0,#0,r5,c3,c0,#0");                                       \
    }                                                                                 \
    ...
    if (DOUBLE_READ_ADDERS)                                                           \
    {                                                                                 \
        asm volatile("MRC  p0,#0x1,r6,c1,c0,#0");                                     \
        asm volatile("MRC  p0,#0x1,r7,c3,c0,#0");                                     \
    }                                                                                 \
    else                                                                              \
    {                                                                                 \
        asm volatile("MRC  p0,#0,r6,c1,c0,#0");                                       \
        asm volatile("MRC  p0,#0,r7,c3,c0,#0");                                       \
    }                                                                                 \
    PQ_RUN_OPCODE_R4_R5(BATCH_OPCODE, BATCH_MACHINE);                                 \
    asm volatile("STRD r6,r7,[r1],#8");                                               \
    if (!last)                                                                        \
 ...
 */
#define _pq_initiate_vector_func(pSrc, pDst)               \
    asm volatile("MOV r0,  %[pSrc]" : : [pSrc] "r"(pSrc)); \
    asm volatile("MOV r1,  %[pDst]" : : [pDst] "r"(pDst)); \
    asm volatile("PUSH {r2-r7}");                          \
    asm volatile("LDRD r2,r3,[r0],#8");
 ...
 */
#define _pq_end_vector_func() asm volatile("POP {r2-r7}")
 ...
 * could be (fx, PQ_LN_INF).
 *
 */
#define _pq_primitive_vector32(format, inf)  \
    _pq_initiate_vector_func(pSrc, pDst);    \
    _pq_vector8_##format(false, false, inf); \
    _pq_vector8_##format(true, false, inf);  \
    _pq_vector8_##format(true, false, inf);  \
    _pq_vector8_##format(true, true, inf);   \
    _pq_end_vector_func();
 ...
 * @code
   ...
   _pq_initiate_vector_func(pSrc,pDst);
   _pq_df2_vector8_fp(false,false);
   _pq_df2_vector8_fp(true,true);
   _pq_end_vector_func();
   @endcode
 *
 */
#define _pq_df2_vector8_fp(middle, last)          \
    asm volatile("MCR      p0,#0x1,r2,c0,c0,#6"); \
    if (middle)                                   \
    {                                             \
        asm volatile("STR      r5,[r1],#4");      \
    }                                             \
    asm volatile("LDRD     r4,r5,[r0],#8");       \
    asm volatile("MRC      p0,#0x1,r2,c0,c0,#0"); \
    asm volatile("MCR      p0,#0x1,r3,c0,c0,#6"); \
    asm volatile("MRC      p0,#0x1,r3,c0,c0,#0"); \
    asm volatile("MCR      p0,#0x1,r4,c0,c0,#6"); \
    asm volatile("STRD     r2,r3,[r1],#8");       \
    asm volatile("MRC      p0,#0x1,r4,c0,c0,#0"); \
    asm volatile("MCR      p0,#0x1,r5,c0,c0,#6"); \
    asm volatile("LDRD     r6,r7,[r0],#8");       \
    asm volatile("MRC      p0,#0x1,r5,c0,c0,#0"); \
    asm volatile("MCR      p0,#0x1,r6,c0,c0,#6"); \
    asm volatile("STRD     r4,r5,[r1],#8");       \
    asm volatile("MRC      p0,#0x1,r6,c0,c0,#0"); \
    asm volatile("MCR      p0,#0x1,r7,c0,c0,#6"); \
    asm volatile("LDRD     r4,r5,[r0],#8");       \
    asm volatile("MRC      p0,#0x1,r7,c0,c0,#0"); \
    asm volatile("MCR      p0,#0x1,r4,c0,c0,#6"); \
    asm volatile("STRD     r6,r7,[r1],#8");       \
    asm volatile("MRC      p0,#0x1,r4,c0,c0,#0"); \
    asm volatile("MCR      p0,#0x1,r5,c0,c0,#6"); \
 ...
 * @code
   ...
   _pq_initiate_vector_func(pSrc,pDst);
   _pq_df2_vector8_fx(false,false);
   _pq_df2_vector8_fx(true,true);
   _pq_end_vector_func();
   @endcode
 *
 */
#define _pq_df2_vector8_fx(middle, last)          \
    asm volatile("MCR      p0,#0x1,r2,c1,c0,#6"); \
    if (middle)                                   \
    {                                             \
        asm volatile("STR      r5,[r1],#4");      \
    }                                             \
    asm volatile("LDRD     r4,r5,[r0],#8");       \
    asm volatile("MRC      p0,#0x1,r2,c1,c0,#0"); \
    asm volatile("MCR      p0,#0x1,r3,c1,c0,#6"); \
    asm volatile("MRC      p0,#0x1,r3,c1,c0,#0"); \
    asm volatile("MCR      p0,#0x1,r4,c1,c0,#6"); \
    asm volatile("STRD     r2,r3,[r1],#8");       \
    asm volatile("MRC      p0,#0x1,r4,c1,c0,#0"); \
    asm volatile("MCR      p0,#0x1,r5,c1,c0,#6"); \
    asm volatile("LDRD     r6,r7,[r0],#8");       \
    asm volatile("MRC      p0,#0x1,r5,c1,c0,#0"); \
    asm volatile("MCR      p0,#0x1,r6,c1,c0,#6"); \
    asm volatile("STRD     r4,r5,[r1],#8");       \
    asm volatile("MRC      p0,#0x1,r6,c1,c0,#0"); \
    asm volatile("MCR      p0,#0x1,r7,c1,c0,#6"); \
    asm volatile("LDRD     r4,r5,[r0],#8");       \
    asm volatile("MRC      p0,#0x1,r7,c1,c0,#0"); \
    asm volatile("MCR      p0,#0x1,r4,c1,c0,#6"); \
    asm volatile("STRD     r6,r7,[r1],#8");       \
    asm volatile("MRC      p0,#0x1,r4,c1,c0,#0"); \
    asm volatile("MCR      p0,#0x1,r5,c1,c0,#6"); \
 ...
 * @code
   ...
   _pq_initiate_vector_func(pSrc, pDst);
   _pq_df2_cascade_vector8_fp(false, false);
   _pq_df2_cascade_vector8_fp(true, true);
   _pq_end_vector_func();
   @endcode
 *
 */
#define _pq_df2_cascade_vector8_fp(middle, last)  \
    asm volatile("MCR  p0,#0x1,r2,c2,c0,#6");     \
    if (middle)                                   \
    {                                             \
        asm volatile("MCR  p0,#0x1,r5,c0,c0,#6"); \
        asm volatile("MRRC p0,#0,r5,r2,c1");      \
    }                                             \
    else                                          \
    {                                             \
        asm volatile("MRC  p0,#0x1,r2,c2,c0,#0"); \
    }                                             \
    asm volatile("MCR  p0,#0x1,r3,c2,c0,#6");     \
    asm volatile("MCR  p0,#0x1,r2,c0,c0,#6");     \
    if (middle)                                   \
    {                                             \
        asm volatile("STRD r4,r5,[r1],#8");       \
    ...
    asm volatile("LDRD r4,r5,[r0],#8");           \
    asm volatile("MRRC p0,#0,r2,r3,c1");          \
    asm volatile("MCR  p0,#0x1,r4,c2,c0,#6");     \
    asm volatile("MCR  p0,#0x1,r3,c0,c0,#6");     \
    asm volatile("LDRD r6,r7,[r0],#8");           \
    asm volatile("MRRC p0,#0,r3,r4,c1");          \
    asm volatile("MCR  p0,#0x1,r5,c2,c0,#6");     \
    asm volatile("MCR  p0,#0x1,r4,c0,c0,#6");     \
    asm volatile("STRD r2,r3,[r1],#8");           \
    asm volatile("MRRC p0,#0,r4,r5,c1");          \
    asm volatile("MCR  p0,#0x1,r6,c2,c0,#6");     \
    asm volatile("MCR  p0,#0x1,r5,c0,c0,#6");     \
    asm volatile("STR  r4,[r1],#4");              \
    asm volatile("MRRC p0,#0,r5,r6,c1");          \
    asm volatile("MCR  p0,#0x1,r7,c2,c0,#6");     \
    asm volatile("MCR  p0,#0x1,r6,c0,c0,#6");     \
    asm volatile("STR  r5,[r1],#4");              \
    asm volatile("LDRD r4,r5,[r0],#8");           \
    asm volatile("MRRC p0,#0,r6,r7,c1");          \
    ...
    asm volatile("MRRC p0,#0,r7,r4,c1");          \
    asm volatile("MCR  p0,#0x1,r5,c2,c0,#6");     \
    asm volatile("MCR  p0,#0x1,r4,c0,c0,#6");     \
    asm volatile("STRD r6,r7,[r1],#8");           \
    asm volatile("MRRC p0,#0,r4,r5,c1");          \
 ...
 * @code
   ...
   _pq_initiate_vector_func(pSrc, pDst);
   _pq_df2_cascade_vector8_fx(false, false);
   _pq_df2_cascade_vector8_fx(true, true);
   _pq_end_vector_func();
   @endcode
 *
 */
#define _pq_df2_cascade_vector8_fx(middle, last)  \
    asm volatile("MCR  p0,#0x1,r2,c3,c0,#6");     \
    if (middle)                                   \
    {                                             \
        asm volatile("MCR  p0,#0x1,r5,c1,c0,#6"); \
        asm volatile("MRC  p0,#0x1,r5,c1,c0,#0"); \
        asm volatile("MRC  p0,#0x1,r2,c3,c0,#0"); \
    }                                             \
    else                                          \
    {                                             \
        asm volatile("MRC  p0,#0x1,r2,c3,c0,#0"); \
    }                                             \
    asm volatile("MCR  p0,#0x1,r3,c3,c0,#6");     \
    asm volatile("MCR  p0,#0x1,r2,c1,c0,#6");     \
    if (middle)                                   \
    {                                             \
        asm volatile("STRD r4,r5,[r1],#8");       \
    ...
    asm volatile("MRC  p0,#0x1,r2,c1,c0,#0");     \
    asm volatile("MRC  p0,#0x1,r3,c3,c0,#0");     \
    asm volatile("MCR  p0,#0x1,r4,c3,c0,#6");     \
    asm volatile("MCR  p0,#0x1,r3,c1,c0,#6");     \
    asm volatile("LDRD r6,r7,[r0],#8");           \
    asm volatile("MRC  p0,#0x1,r3,c1,c0,#0");     \
    asm volatile("MRC  p0,#0x1,r4,c3,c0,#0");     \
    asm volatile("MCR  p0,#0x1,r5,c3,c0,#6");     \
    asm volatile("MCR  p0,#0x1,r4,c1,c0,#6");     \
    asm volatile("STRD r2,r3,[r1],#8");           \
    asm volatile("MRC  p0,#0x1,r4,c1,c0,#0");     \
    asm volatile("MRC  p0,#0x1,r5,c3,c0,#0");     \
    asm volatile("MCR  p0,#0x1,r6,c3,c0,#6");     \
    asm volatile("MCR  p0,#0x1,r5,c1,c0,#6");     \
    asm volatile("STR  r4,[r1],#4");              \
    asm volatile("MRC  p0,#0x1,r5,c1,c0,#0");     \
    asm volatile("MRC  p0,#0x1,r6,c3,c0,#0");     \
    asm volatile("MCR  p0,#0x1,r7,c3,c0,#6");     \
    asm volatile("MCR  p0,#0x1,r6,c1,c0,#6");     \
    asm volatile("STR  r5,[r1],#4");              \
    asm volatile("LDRD r4,r5,[r0],#8");           \
    asm volatile("MRC  p0,#0x1,r6,c1,c0,#0");     \
 ...
 *
 * @param  *pSrc      points to the block of input data. The input value is in radians, the range is (-INFINITY +INFINITY).
 * @param  *pDst      points to the block of output data
 */
...
#if defined(FSL_FEATURE_POWERQUAD_SIN_COS_FIX_ERRATA) && FSL_FEATURE_POWERQUAD_SIN_COS_FIX_ERRATA
    const int32_t magic = 0x30c90fdb;
    float valFloat = *(const float *)(&magic) * (float)(val << 16);
#endif
 ...
 * @param  *pDst      points to the block of output data.
 */
static inline void PQ_Vector32InvFP(float *pSrc, float *pDst){_pq_primitive_vector32(fp, PQ_INV_INF)};
 ...
 * @param  *pDst      points to the block of output data.
 */
static inline void PQ_Vector32LnFP(float *pSrc, float *pDst){_pq_primitive_vector32(fp, PQ_LN_INF)};
 ...
 * @param  *pDst      points to the block of output data.
 */
static inline void PQ_Vector32SqrtFP(float *pSrc, float *pDst){_pq_primitive_vector32(fp, PQ_SQRT_INF)};
 ...
 * @param  *pDst      points to the block of output data.
 */
static inline void PQ_Vector32InvSqrtFP(float *pSrc, float *pDst){_pq_primitive_vector32(fp, PQ_ISQRT_INF)};
 ...
 * @param  *pDst      points to the block of output data.
 */
static inline void PQ_Vector32EtoxFP(float *pSrc, float *pDst){_pq_primitive_vector32(fp, PQ_ETOX_INF)};
 ...
 * @param  *pDst      points to the block of output data.
 */
static inline void PQ_Vector32EtonxFP(float *pSrc, float *pDst){_pq_primitive_vector32(fp, PQ_ETONX_INF)};
 ...
 * @param  *pDst      points to the block of output data.
 */
static inline void PQ_Vector32SinFP(float *pSrc, float *pDst){_pq_primitive_vector32(fp, PQ_SIN_INF)};
 ...
 * @param  *pDst      points to the block of output data.
 */
static inline void PQ_Vector32CosFP(float *pSrc, float *pDst){_pq_primitive_vector32(fp, PQ_COS_INF)};
 ...
 * @param  *pDst      points to the block of output data.
 */
static inline void PQ_Vector32InvFX(int32_t *pSrc, int32_t *pDst){_pq_primitive_vector32(fx, PQ_INV_INF)};
 ...
 * @param  *pDst      points to the block of output data.
 */
static inline void PQ_Vector32LnFX(int32_t *pSrc, int32_t *pDst){_pq_primitive_vector32(fx, PQ_LN_INF)};
 ...
 * @param  *pDst      points to the block of output data.
 */
static inline void PQ_Vector32SqrtFX(int32_t *pSrc, int32_t *pDst){_pq_primitive_vector32(fx, PQ_SQRT_INF)};
 ...
 * @param  *pDst      points to the block of output data.
 */
static inline void PQ_Vector32InvSqrtFX(int32_t *pSrc, int32_t *pDst){_pq_primitive_vector32(fx, PQ_ISQRT_INF)};
 ...
 * @param  *pDst      points to the block of output data.
 */
static inline void PQ_Vector32EtoxFX(int32_t *pSrc, int32_t *pDst){_pq_primitive_vector32(fx, PQ_ETOX_INF)};
 ...
 * @param  *pDst      points to the block of output data.
 */
static inline void PQ_Vector32EtonxFX(int32_t *pSrc, int32_t *pDst){_pq_primitive_vector32(fx, PQ_ETONX_INF)};
 ...
 * @param  *pDst      points to the block of output data.
 */
static inline void PQ_Vector32SinFX(int32_t *pSrc, int32_t *pDst){_pq_primitive_vector32(fx, PQ_SIN_INF)};
 ...
 * @param  *pDst      points to the block of output data.
 */
static inline void PQ_Vector32CosFX(int32_t *pSrc, int32_t *pDst){_pq_primitive_vector32(fx, PQ_COS_INF)};

/*!
 * @brief Processing function for the floating-point vectorised biquad direct form II.
 *
 * @param  *pSrc      points to the block of 16-byte input data
 * @param  *pDst      points to the block of 16-byte output data.
 */
static inline void PQ_Vector16BiqaudDf2FP(float *pSrc, float *pDst)
{
    _pq_initiate_vector_func(pSrc, pDst);
    _pq_df2_vector8_fp(false, false);
    _pq_df2_vector8_fp(true, true);
...
/*!
 * @brief Processing function for the fixed-point vectorised biquad direct form II.
 *
 * @param  *pSrc      points to the block of 16-byte input data
 * @param  *pDst      points to the block of 16-byte output data.
 */
static inline void PQ_Vector16BiqaudDf2FX(int32_t *pSrc, int32_t *pDst)
{
    _pq_initiate_vector_func(pSrc, pDst);
    _pq_df2_vector8_fx(false, false);
    _pq_df2_vector8_fx(true, true);
 ...
 * @param  *pDst      points to the block of 16-byte output data.
 */
static inline void PQ_Vector16BiqaudCascadeDf2FP(float *pSrc, float *pDst)
{
    _pq_initiate_vector_func(pSrc, pDst);
    _pq_df2_cascade_vector8_fp(false, false);
    _pq_df2_cascade_vector8_fp(true, true);
 ...
 * @param  *pDst      points to the block of 16-byte output data.
 */
static inline void PQ_Vector16BiqaudCascadeDf2FX(int32_t *pSrc, int32_t *pDst)
{
    _pq_initiate_vector_func(pSrc, pDst);
    _pq_df2_cascade_vector8_fx(false, false);
    _pq_df2_cascade_vector8_fx(true, true);
