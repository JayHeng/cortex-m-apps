...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_AD_24_LPUART1_TX,        /* GPIO_AD_B0_12 is configured as LPUART1_TX */
      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
      IOMUXC_GPIO_AD_25_LPUART1_RX,        /* GPIO_AD_B0_13 is configured as LPUART1_RX */
      1U);                                    /* Software Input On Field: Input Path is determined by functionality */

  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_AD_24_LPUART1_TX,        /* GPIO_AD_B0_12 PAD functional properties : */
  ...
  IOMUXC_SetPinConfig(
      IOMUXC_GPIO_AD_25_LPUART1_RX,        /* GPIO_AD_B0_13 PAD functional properties : */
      0x0u);                               /* Slew Rate Field: Slow Slew Rate
                                                 Drive Strength Field: R0/6
                                                 Speed Field: medium(100MHz)
                                                 Open Drain Enable Field: Open Drain Disabled
