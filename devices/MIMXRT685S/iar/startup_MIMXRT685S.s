...
__vector_table_0x1c
        ...
        ; External Interrupts
        DCD     WDT0_IRQHandler  ; Windowed watchdog timer 0 interrupt
        DCD     DMA0_IRQHandler  ; DMA controller 0 interrupt
        ...
        DCD     FLEXCOMM15_IRQHandler  ; Flexcomm Interface 15 (I2C)
        ...
        DCD     SECURE_VIOLATION_IRQHandler  ; Secure violation
        ...
        DCD     I3C_IRQHandler  ; I3C
        DCD     USB0_IRQHandler  ; USB device
        DCD     USB0_NEEDCLK_IRQHandler  ; USB Activity Wake-up Interrupt
        DCD     WDT1_IRQHandler  ; Windowed watchdog timer 1 interrupt
        DCD     Reserved69_IRQHandler  ; Reserved interrupt
        DCD     DMA1_IRQHandler  ; DMA controller 1 interrupt
        DCD     PUF_IRQHandler  ;
        DCD     POWERQUAD_IRQHandler  ;
        DCD     CASPER_IRQHandler  ;
        DCD     PMC_IRQHandler  ; Power Management Control interrupt
        DCD     HASHCRYPT_IRQHandler  ; Hash-Crypt interrupt
        DCD     DPM_IRQHandler  ;
