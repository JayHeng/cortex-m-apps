...
{ .number_of_pins = sizeof(g_bsp_pin_lpm_cfg_data) / sizeof(ioport_pin_cfg_t), .p_pin_cfg_data =
          &g_bsp_pin_lpm_cfg_data[0], };
...
void R_BSP_PinCfgSecurityInit(void)
{
    ...
    for(uint32_t i = 0; i < g_bsp_pin_lpm_cfg.number_of_pins; i++)
    {
        uint32_t port_pin = g_bsp_pin_lpm_cfg.p_pin_cfg_data[i].pin;
