...
#ifndef _PU_IROM_OCOTP_H
#define _PU_IROM_OCOTP_H

/*=============================================================================

 Module Name:  pu_irom_ocotp.h

  General Description: Contains OCOTP fuse definitions.

===============================================================================
                    Copyright: 2008,2010,2011,2012,2013 FREESCALE, INC.
...
#define ROM_OCOTP_INFINITE_LOOP_VALUE() \
        ((SRC->SBMR1&ROM_OCOTP_INFINITE_LOOP_MASK) >> ROM_OCOTP_INFINITE_LOOP_SHIFT)
...
#define ROM_OCOTP_HOLD_TIME_VALUE() \
        ((SRC->SBMR1&ROM_OCOTP_HOLD_TIME_MASK) >> ROM_OCOTP_HOLD_TIME_SHIFT)

/* Encrypted XIP */
#define ROM_OCOTP_ENCRYPT_XIP_MASK  0x00000002
#define ROM_OCOTP_ENCRYPT_XIP_SHIFT 0x01
#define ROM_OCOTP_ENCRYPT_XIP_VALAUE() \
        ((SRC->SBMR1&ROM_OCOTP_ENCRYPT_XIP_MASK) >> ROM_OCOTP_ENCRYPT_XIP_SHIFT)
...
#define ROM_OCOTP_FLEXSPI_RESET_PIN_ENABLE_SHIFT (7U)
#define ROM_OCOTP_FLEXSPI_RESET_PIN_ENABLE_MASK  (1U << ROM_OCOTP_FLEXSPI_RESET_PIN_ENABLE_SHIFT)
#define ROM_OCOTP_FLEXSPI_RESET_PIN_ENABLE_VALUE() \
            ((HW_OCOTP_REG_RD(0x2E) & ROM_OCOTP_FLEXSPI_RESET_PIN_ENABLE_MASK) >> ROM_OCOTP_FLEXSPI_RESET_PIN_ENABLE_SHIFT)
           
/* FlexSPI JEDEC HW reset enable */
#define ROM_OCOTP_FLEXSPI_JEDEC_HW_RESET_PIN_ENABLE_SHIFT (6U)
#define ROM_OCOTP_FLEXSPI_JEDEC_HW_RESET_PIN_ENABLE_MASK  (1U << ROM_OCOTP_FLEXSPI_JEDEC_HW_RESET_PIN_ENABLE_SHIFT)
#define ROM_OCOTP_FLEXSPI_JEDEC_HW_RESET_PIN_ENABLE_VALUE() \
            ((HW_OCOTP_REG_RD(0x2E) & ROM_OCOTP_FLEXSPI_JEDEC_HW_RESET_PIN_ENABLE_MASK) >> ROM_OCOTP_FLEXSPI_JEDEC_HW_RESET_PIN_ENABLE_SHIFT)
...
#define ROM_OCOTP_SAFE_FREQ_VALUE() \
        ((SRC->SBMR1&ROM_OCOTP_SAFE_FREQ_MASK) >> ROM_OCOTP_SAFE_FREQ_SHIFT)
...
#define ROM_OCOTP_CS_INTERVAL_VALUE()   \
        ((SRC->SBMR1&ROM_OCOTP_CS_INTERVAL_MASK) >> ROM_OCOTP_CS_INTERVAL_SHIFT)
...
#define ROM_OCOTP_SPI_NAND_BOOT_BUSY_BIT_OFFSET_OVERRIDE_VALUE()    \
        ((HW_OCOTP_REG_RD(0x2E)&ROM_OCOTP_SPI_NAND_BOOT_BUSY_BIT_OFFSET_OVERRIDE_MASK) >>ROM_OCOTP_SPI_NAND_BOOT_BUSY_BIT_OFFSET_OVERRIDE_SHIFT)
...
#define ROM_OCOTP_SPI_NAND_BOOT_BUSY_BIT_OFFSET_VALUE() \
        ((HW_OCOTP_REG_RD(0x2E)&ROM_OCOTP_SPI_NAND_BOOT_BUSY_BIT_OFFSET_MASK) >> ROM_OCOTP_SPI_NAND_BOOT_BUSY_BIT_OFFSET_SHIFT)
...
#define ROM_OCOTP_SEMC_NAND_ROW_COL_ADDR_MODE_VALUE() \
        ((HW_OCOTP_REG_RD(0x2E)&ROM_OCOTP_SEMC_NAND_ROW_COL_ADDR_MODE_MASK) >> ROM_OCOTP_SEMC_NAND_ROW_COL_ADDR_MODE_SHIFT)
...
#define ROM_OCOTP_SEMC_NAND_COL_ADDRESS_WIDTH_VALUE() \
        ((HW_OCOTP_REG_RD(0x2E)&ROM_OCOTP_SEMC_NAND_COL_ADDRESS_WIDTH_MASK) >> ROM_OCOTP_SEMC_NAND_COL_ADDRESS_WIDTH_SHIFT)
...
#define ROM_OCOTP_SEMC_NAND_DEVICE_ECC_STATUS_VALUE() \
        ((HW_OCOTP_REG_RD(0x2E)&ROM_OCOTP_SEMC_NAND_DEVICE_ECC_STATUS_MASK) >> ROM_OCOTP_SEMC_NAND_DEVICE_ECC_STATUS_SHIFT)
...
#define ROM_OCOTP_RECOVERY_SPI_EEPROM_BOOT_ENABLE_VALUE() \
        ((HW_OCOTP_REG_RD(0x2D)&ROM_OCOTP_RECOVERY_SPI_EEPROM_BOOT_ENABLE_MASK) >> ROM_OCOTP_RECOVERY_SPI_EEPROM_BOOT_ENABLE_SHIFT)
...
#define ROM_OCOTP_DCP_DISABLE_VALUE() \
      ((HW_OCOTP_REG_RD(3)&ROM_OCOTP_DCP_DISABLE_MASK) >> ROM_OCOTP_DCP_DISBALE_SHIFT)
...
#define ROM_OCOTP_BEE_KEY0_SEL_VALUE() ((HW_OCOTP_REG_RD(6)&ROM_OCOTP_BEE_KEY0_SEL_MASK) >> ROM_OCOTP_BEE_KEY0_SEL_SHIFT)
#define ROM_OCOTP_BEE_KEY1_SEL_SHIFT  (14)
#define ROM_OCOTP_BEE_KEY1_SEL_MASK   (3UL << ROM_OCOTP_BEE_KEY1_SEL_SHIFT)
#define ROM_OCOTP_BEE_KEY1_SEL_VALUE() ((HW_OCOTP_REG_RD(6)&ROM_OCOTP_BEE_KEY1_SEL_MASK) >> ROM_OCOTP_BEE_KEY1_SEL_SHIFT)


/* SEC config0 fuse */
#define ROM_OCOTP_SEC_CONFIG0_MASK (0x00000002)
#define ROM_OCOTP_SEC_CONFIG0_SHIFT ((uint8_t)1)
#define ROM_OCOTP_SEC_CONFIG0_VALUE() \
    ((HW_OCOTP_REG_RD(4)&ROM_OCOTP_SEC_CONFIG0_MASK) >> ROM_OCOTP_SEC_CONFIG0_SHIFT)

/* SEC_Config[1] */
#define ROM_OCOTP_SEC_CONFIG1_MASK  0x00000002
#define ROM_OCOTP_SEC_CONFIG1_SHIFT ((uint8_t)0)
#define ROM_OCOTP_SEC_CONFIG1_VALUE()   \
        ((HW_OCOTP_REG_RD(6)&ROM_OCOTP_SEC_CONFIG1_MASK) >> ROM_OCOTP_SEC_CONFIG1_SHIFT)
...
#define ROM_OCOTP_SDMMC_OVERRIDE_PAD_SETTINGS_ENABLE_MASK ((uint32_t)(0x1 << ROM_OCOTP_SDMMC_OVERRIDE_PAD_SETTINGS_ENABLE_SHIFT))
#define ROM_OCOTP_SDMMC_OVERRIDE_PAD_SETTINGS_ENABLE_VALUE() \
        ((HW_OCOTP_REG_RD(7) & ROM_OCOTP_SDMMC_OVERRIDE_PAD_SETTINGS_ENABLE_MASK) >> ROM_OCOTP_SDMMC_OVERRIDE_PAD_SETTINGS_ENABLE_SHIFT)
...
#define USDHC_CMD_OE_PRE_EN_VALUE() \
        ((HW_OCOTP_REG_RD(7) & USDHC_CMD_OE_PRE_EN_MASK) >> USDHC_CMD_OE_PRE_EN_SHIFT)
...
#define ROM_OCOTP_MMC_SPEED_VALUE() \
        ((SRC->SBMR1 & ROM_OCOTP_MMC_SPEED_MASK) >> ROM_OCOTP_MMC_SPEED_SHIFT)
...
#define ROM_OCOTP_MMC_BUS_WIDTH_VALUE() \
        ((SRC->SBMR1 & ROM_OCOTP_MMC_BUS_WIDTH_MASK) >> ROM_OCOTP_MMC_BUS_WIDTH_SHIFT)
...
#define ROM_OCOTP_SD_SPEED_VALUE()  \
        ((SRC->SBMR1 & ROM_OCOTP_SD_SPEED_MASK) >> ROM_OCOTP_SD_SPEED_SHIFT)
...
#define ROM_OCOTP_SD_BUS_WIDTH_VALUE()  \
        ((SRC->SBMR1 & ROM_OCOTP_SD_BUS_WIDTH_MASK) >> ROM_OCOTP_SD_BUS_WIDTH_SHIFT)
...
#define ROM_OCOTP_DIR_BT_DIS_VALUE()    \
        ((HW_OCOTP_REG_RD(6)&ROM_OCOTP_DIR_BT_DIS_MASK) >> ROM_OCOTP_DIR_BT_DIS_SHIFT)

/* BT_FUSE_SEL */
#define ROM_OCOTP_BT_FUSE_SEL_MASK  0x00000010
#define ROM_OCOTP_BT_FUSE_SEL_SHIFT ((uint8_t)4)
#define ROM_OCOTP_BT_FUSE_SEL_VALUE()   \
        ((HW_OCOTP_REG_RD(6)&ROM_OCOTP_BT_FUSE_SEL_MASK) >> ROM_OCOTP_BT_FUSE_SEL_SHIFT)
...
#define ROM_OCOTP_SDP_DISABLE_VALUE()   \
        ((HW_OCOTP_REG_RD(6)&ROM_OCOTP_SDP_DISABLE_MASK) >> ROM_OCOTP_SDP_DISABLE_SHIFT)
...
#define ROM_OCOTP_WDOG_ENABLE_VALUE() \
    ((HW_OCOTP_REG_RD(6)&ROM_OCOTP_WDOG_ENABLE_MASK) >> ROM_OCOTP_WDOG_ENABLE_SHIFT)


/* XRDC_ENABLE fuse */
#define ROM_OCOTP_XRDC_ENABLE_MASK (0x10000000)
#define ROM_OCOTP_XRDC_ENABLE_SHIFT ((uint8_t)28)
#define ROM_OCOTP_XRDC_ENABLE_VALUE() \
        ((HW_OCOTP_REG_RD(6) & ROM_OCOTP_SRDC_ENABLE_MASK) >> ROM_OCOTP_SRDC_ENABLE_SHIFT)
...
/* =================== OCOTP CFG8 REGISTER ENTRIES ==========================*/

/* LDO_VOLT_SETTING fuse */
#define LDO_VOLT_SETTING_MASK   (0x30000000)
#define LDP_VOLT_SETTING_SHIFT ((uint8_t)28)
#define LDP_VOLT_SETTING_VALUE() \
        ((HW_OCOTP_REG_RD(8) & LDO_VOLT_SETTING_MASK) >> LDP_VOLT_SETTING_SHIFT)

/* LDO_VOLT_CHANG_EN fuse */
#define LDO_VOLT_CHANG_EN_MASK (0x40000000)
#define LDO_VOLT_CHANG_EN_SHIFT ((uint8_t)30)
#define LDO_VOLT_CHANG_EN_VALUE() \
        ((HW_OCOTP_REG_RD(8) & LDO_VOLT_CHANG_EN_MASK) >> LDO_VOLT_CHANG_EN_SHIFT)

/* =================== OCOTP CFG8 REGISTER ENTRIES END==========================*/


/* =================== OCOTP CFG15 REGISTER ENTRIES ==========================*/

//#ifndef PROTOTYPE
/* VID overwrites in efuses */
#define OCOTP_GP1_CUST_USB_VID_MASK              (0x0000ffff)
#define OCOTP_GP1_CUST_USB_VID_SHIFT              ((uint8_t)0)

#define ROM_OCOTP_GP1_CUST_USB_VID() \
    ((HW_OCOTP_REG_RD(15)&OCOTP_GP1_CUST_USB_VID_MASK) >> OCOTP_GP1_CUST_USB_VID_SHIFT)

/* PID overwrites in efuses */
#define OCOTP_GP1_CUST_USB_PID_MASK              (0xffff0000)
#define OCOTP_GP1_CUST_USB_PID_SHIFT             ((uint8_t)16)

#define ROM_OCOTP_GP1_CUST_USB_PID() \
    ((HW_OCOTP_REG_RD(15)&OCOTP_GP1_CUST_USB_PID_MASK) >> OCOTP_GP1_CUST_USB_PID_SHIFT)
//#else // PROTOTYPE
//#define ROM_OCOTP_GP1_CUST_USB_VID() 0
//#define ROM_OCOTP_GP1_CUST_USB_PID() 0
//#endif // PROTOTYPE

/* =================== OCOTP CFG15 REGISTER ENTRIES END==========================*/
...
#define ROM_OCOTP_WDOG_TIMEOUT_SEL_MASK     (0x7u << ROM_OCOTP_WDOG_TIMEOUT_SEL_SHIFT)
...
/* MPU protection */
#define ROM_OCOTP_MPU_PROT_EN_SHIFT (12u)
#define ROM_OCOTP_MPU_PROT_EN_MASK  (1u << ROM_OCOTP_MPU_PROT_EN_SHIFT)
#define ROM_OCOTP_MPU_PROT_EN_VALUE() \
((HW_OCOTP_REG_RD(45) & ROM_OCOTP_MPU_PROT_EN_MASK) >> ROM_OCOTP_MPU_PROT_EN_SHIFT)

/* ============== OCOTP CFG45 REGISTER ENTRIES END - 0x6D0 ===================*/


/* ============= DCDC Trimmed value load ====================*/
#define ROM_OCOTP_DCDC_TRIM_EN_SHIFT (10)
#define ROM_OCOTP_DCDC_TRIM_EN_MASK  (1U << ROM_OCOTP_DCDC_TRIM_EN_SHIFT)
#define ROM_OCOTP_DCDC_TRIM_EN_VALUE() \
        ((HW_OCOTP_REG_RD(0x9)&ROM_OCOTP_DCDC_TRIM_EN_MASK) >> ROM_OCOTP_DCDC_TRIM_EN_SHIFT)

#define ROM_OCOTP_DCDC_VBG_TRIM_SHIFT (11)
#define ROM_OCOTP_DCDC_VBG_TRIM_MASK  (0x1FU << ROM_OCOTP_DCDC_VBG_TRIM_SHIFT)
#define ROM_OCOTP_DCDC_VBG_TRIM_VALUE() \
        ((HW_OCOTP_REG_RD(0x9)&ROM_OCOTP_DCDC_VBG_TRIM_MASK) >> ROM_OCOTP_DCDC_VBG_TRIM_SHIFT)

#define  ROM_OCOTP_DCDC_VOLT_CHANG_EN_SHIFT (30)
#define  ROM_OCOTP_DCDC_VOLT_CHANG_EN_MASK (1U << ROM_OCOTP_DCDC_VOLT_CHANG_EN_SHIFT)
#define ROM_OCOTP_DCDC_VOLT_CHANG_EN_VALUE() \
        ((HW_OCOTP_REG_RD(0x08)&ROM_OCOTP_DCDC_VOLT_CHANG_EN_MASK) >> ROM_OCOTP_DCDC_VOLT_CHANG_EN_SHIFT)

#define  ROM_OCOTP_DCDC_VOLT_SETTING_SHIFT (28)
#define  ROM_OCOTP_DCDC_VOLT_SETTING_MASK (3U << ROM_OCOTP_DCDC_VOLT_SETTING_SHIFT)
#define ROM_OCOTP_DCDC_VOLT_SETTING_VALUE() \
        ((HW_OCOTP_REG_RD(0x08)&ROM_OCOTP_DCDC_VOLT_SETTING_MASK) >> ROM_OCOTP_DCDC_VOLT_SETTING_SHIFT)


/* ================ OCOTP MISC. REGISTER ENTRIES ======================*/
/* Field_Return */
#define ROM_OCOTP_FIELD_RETURN_SHIFT    ((uint8_t)31)
#define ROM_OCOTP_FIELD_RETURN_MASK     (1U << ROM_OCOTP_FIELD_RETURN_SHIFT)
#define ROM_OCOTP_FIELD_RETURN_VALUE()  \
        ((HW_OCOTP_REG_RD(0x0)&ROM_OCOTP_FIELD_RETURN_MASK) >> ROM_OCOTP_FIELD_RETURN_SHIFT)

/* MC_ERA */
#define ROM_OCOTP_MC_ERA_MASK   0x0000FF00
#define ROM_OCOTP_MC_ERA_SHIFT  ((uint8_t)8)
#define ROM_OCOTP_MC_ERA_VALUE()    \
        ((HW_OCOTP_REG_RD(0x2F)&ROM_OCOTP_MC_ERA_MASK) >> ROM_OCOTP_MC_ERA_SHIFT)

/* AP_BI_Ver */
#define ROM_OCOTP_AP_BI_VER_MASK    0xFFFF0000
#define ROM_OCOTP_AP_BI_VER_SHIFT   ((uint8_t)24)
#define ROM_OCOTP_AP_BI_VER_VALUE() \
        ((HW_OCOTP_REG_RD(0x2F)&ROM_OCOTP_AP_BI_VER_MASK) >> ROM_OCOTP_AP_BI_VER_SHIFT)
