...
static status_t I3C_MasterWaitForTxReady(I3C_Type *base)
{
    ...
    status_t result;
    size_t txCount;
    size_t txFifoSize = 2U << ((base->CAPABILITIES & I3C_CAPABILITIES_FIFOTX_MASK) >> I3C_CAPABILITIES_FIFOTX_SHIFT);
...
void I3C_MasterSetBaudRate(I3C_Type *base, uint32_t baudRate_Hz, uint32_t sourceClock_Hz)
{
    ...
    base->MCONFIG =
        (base->MCONFIG &
         ~(I3C_MCONFIG_PPBAUD_MASK | I3C_MCONFIG_PPLOW_MASK | I3C_MCONFIG_ODBAUD_MASK | I3C_MCONFIG_I2CBAUD_MASK)) |
...
status_t I3C_MasterReceive(I3C_Type *base, void *rxBuff, size_t rxSize, uint32_t flags)
{
    ...
    while (rxSize || !completed)
    {
        ...
        {
            *buf++ = base->MRDATAB & I3C_MRDATAB_DATA0_MASK;
            rxSize--;
        }
    }
