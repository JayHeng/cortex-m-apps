...
#define DCDC_TARGET_VOLTAGE_OD 1100
#define DCDC_TARGET_VOLTAGE_NM 1000
#define DCDC_TARGET_VOLTAGE_UD 900
#ifndef DCDC_TARGET_VOLTAGE
#define DCDC_TARGET_VOLTAGE DCDC_TARGET_VOLTAGE_NM
#endif
